...
from Demonchat import Demonchat as app, save_clonebot_owner, save_idclonebot_owner
from Demonchat import Demonchat, db as mongodb
    ...
    if len(message.command) > 1:
        ...
        try:
            ai = Client(
                ...
                no_updates=False,
                plugins=dict(root="Demonchat.idchatbot"),
            )
            await ai.start()
