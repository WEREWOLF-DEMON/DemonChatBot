...
from Demonchat.database.chats import add_served_chat
from Demonchat.database.users import add_served_user
from Demonchat.database import chatai, abuse_list
from config import MONGO_URL, OWNER_ID
from Demonchat import Demonchat, mongo, LOGGER, db
from Demonchat.modules.helpers import CHATBOT_ON, languages
...
@Demonchat.on_message(filters.command("block"))
...
@Demonchat.on_callback_query(filters.regex(r"^(accept_block|decline_block):"), group=-3)
...
@Demonchat.on_message(filters.command("unblock") & filters.user(OWNER_ID))
...
@Demonchat.on_message(filters.command("blocked") & filters.user(OWNER_ID))
...
@Demonchat.on_message(filters.incoming)
async def chatbot_response(client: Client, message: Message):
    ...
    try:
        ...
        if (message.reply_to_message and message.reply_to_message.from_user.id == Demonchat.id) or not message.reply_to_message:
