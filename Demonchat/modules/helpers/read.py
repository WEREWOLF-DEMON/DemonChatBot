...
║ ➻ ᴄʀᴇᴀᴛᴏʀ ➪ [ᴡᴇʀᴇᴡᴏʟꜰ ✯ ᴅᴇᴍᴏɴ](https://t.me/WerewolfDemon)                         
╚═════════════════╝
**"""
...
──────────────
๏ ᴍᴀᴅᴇ ʙʏ ➪ [ᴡᴇʀᴇᴡᴏʟꜰ ✯ ᴅᴇᴍᴏɴ](https://t.me/WerewolfDemon) 💞**
"""
...
──────────────
➻ /idclone [ ᴩʏʀᴏɢʀᴀᴍ ꜱᴛʀɪɴɢ ꜱᴇꜱꜱɪᴏɴ ] - ᴛᴏ ᴍᴀᴋᴇ ɪᴅ-ᴅᴇᴍᴏɴᴄʜᴀᴛʙᴏᴛ.
──────────────
📡 ᴍᴀᴅᴇ ʙʏ ➪ [ᴡᴇʀᴇᴡᴏʟꜰ ✯ ᴅᴇᴍᴏɴ](https://t.me/WerewolfDemon) 💞**
"""

SOURCE_READ = f"**ʜᴇʏ, ᴛʜᴇ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ᴏғ [{Demonchat.name}](https://t.me/{Demonchat.username}) ɪs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.**\n**ᴘʟᴇᴀsᴇ ғᴏʀᴋ ᴛʜᴇ ʀᴇᴘᴏ & ɢɪᴠᴇ ᴛʜᴇ sᴛᴀʀ ✯**\n**──────────────────**\n**ʜᴇʀᴇ ɪs ᴛʜᴇ [sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ](https://github.com/yourtoofan)**\n**──────────────────**\n**ɪғ ʏᴏᴜ ғᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ᴛʜᴇɴ ᴄᴏɴᴛᴀᴄᴛ ᴀᴛ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://t.me/{SUPPORT_GRP}).\n<b>||📡 ᴍᴀᴅᴇ ʙʏ ➪ [ʟᴇɢᴇɴᴅ ✯ ᴍɪᴄᴋᴇʏ](https://t.me/WerewolfDemon) 💞**||</b>"

ADMIN_READ = f"sᴏᴏɴ"

ABOUT_READ = f"""
**➻ [{Demonchat.name}](https://t.me/{Demonchat.username}) ɪs ᴀɴ ᴀɪ ʙᴀsᴇᴅ ᴄʜᴀᴛ-ʙᴏᴛ.**
**➻ [{Demonchat.name}](https://t.me/{Demonchat.username}) ʀᴇᴘʟɪᴇs ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴛᴏ ᴀ ᴜsᴇʀ.**
...
**──────────────**
**➻ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ғᴏʀ ɢᴇᴛᴛɪɴɢ ʙᴀsɪᴄ ʜᴇʟᴩ ᴀɴᴅ ɪɴғᴏ ᴀʙᴏᴜᴛ [{Demonchat.name}](https://t.me/{Demonchat.username})**
"""
