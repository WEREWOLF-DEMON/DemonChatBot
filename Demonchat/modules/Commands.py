...
from Demonchat import Demonchat, mongo, LOGGER, db, SUDOERS
from Demonchat.modules.helpers import languages, CHATBOT_ON
...
@Demonchat.on_message(filters.command(["lang", "language", "setlang"]))
...
@Demonchat.on_message(filters.command("status"))
...
@Demonchat.on_message(filters.command(["resetlang", "nolang"]))
...
@Demonchat.on_message(filters.command("chatbot"))
