...
from Demonchat.database import abuse_list, add_served_cchat, add_served_cuser, chatai
from config import MONGO_URL, OWNER_ID
from Demonchat import Demonchat, mongo, LOGGER, db
from Demonchat.idchatbot.helpers import languages
import asyncio
...
async def request_block_word(client: Client, message: Message):
    try:
        ...
        await Demonchat.send_message(OWNER_ID, review_message, reply_markup=buttons)
